package mmo.framework.domain.fairy
{
	...
	public class FairyEnemyBuff
	{
		...
		public function FairyEnemyBuff(buffId:int, name:String, desc:String, buffType:String, extData:Object=null)
		{
			_buffId = buffId;
			_name = name;
			_desc = desc;
		...
		{
			return FairyEnemyBuffType.getBuffTypeIdByName(_buffType);
		}
