package mmo.nurturance.nodehandle.handler
{
	...
	public class FavorHandler implements IChange
	{
		public function FavorHandler()
		{
		}
		...
		public function change(value:*):void
		{
			...
			const PATH:String = "nurturance/nursysui/favormovie0";
			const NAME:String = "mmo.nurturance.FavorMovie";
