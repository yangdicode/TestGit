package mmo.common
{
	...
	public class HanziToPinyinUtil
	{
		...
		public function HanziToPinyinUtil()
		{
		 ...
		 * var py:String = HanziToPinyinUtil.convertString(chinese);
		 * trace(py); //zhrmghg
		 */
		 ...
		 * var py:String = HanziToPinyinUtil.convertChar(chineseChar);
		 * trace(py); //w
		 */
		...
		public static function isEnKong1(argValue)
		{
			var flag=false;
		 ...
		 *
		 */
		public static function cn2asc(cn)
		{
		 ...
		 *
		 */
		public static function pinyin(char)
		{
			...
			var ascCode=AnsiUnicodeConvert.UnicodeToAnsi(cn2asc(char));
