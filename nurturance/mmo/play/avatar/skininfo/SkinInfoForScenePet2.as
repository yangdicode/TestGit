package mmo.play.avatar.skininfo
{
	...
	public class SkinInfoForScenePet2 extends SkinInfo
	{
		function SkinInfoForScenePet2(info:Array = null)
		{
			super(info);
		}
		...
		override protected function getActionInfo():Array {
			...
			return [
				...
				ActionInfo.getInstance("ldwn", 0, 2, 3),	// 普通移动
				ActionInfo.getInstance("rdwn", 1, 2, 3),
				ActionInfo.getInstance("luwn", 2, 2, 3),
				ActionInfo.getInstance("ruwn", 3, 2, 3)
			];
		}
	}
}