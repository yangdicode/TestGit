package mmo.play.avatar.skininfo
{
	 ...
	 * 2.射击帧使用站立帧
	 */
	public class SpecialSkinInfo extends SkinInfo
	{
		public function SpecialSkinInfo(info:Array = null)
		{
			super(info);
		}
		...
		override protected function getActionInfo():Array
		{
			...
			return [
				...
				ActionInfo.getInstance("ldp", 12, 1, 0),	// 采集
				ActionInfo.getInstance("rdp", 13, 1, 0),
				ActionInfo.getInstance("lup", 14, 1, 0),
				ActionInfo.getInstance("rup", 15, 1, 0),
				...
				ActionInfo.getInstance("lds", 0, 1, 0),	// 射击
				ActionInfo.getInstance("rds", 1, 1, 0),
				ActionInfo.getInstance("lus", 2, 1, 0),
				ActionInfo.getInstance("rus", 3, 1, 0)
			];
		}
	}
}